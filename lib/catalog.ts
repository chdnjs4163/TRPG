...
export const gamesByGenre: Record<"판타지" | "모험" | "SF" | "호러", GameSummary[]> = {
  판타지: [
    ...
    { title: "마법사의 탑", image: "/images/Tower_of_Wizards.png", description: "고대 마법사의 탑을 탐험하는 모험.", genre: "판타지" },
    { title: "판타지 세계", image: "/images/the_fantasy_world.png", description: "다양한 종족과 마법이 공존하는 세계.", genre: "판타지" },
  ...
  모험: [
    ...
    { title: "정글 탐험", image: "/images/entrance_to_dungeon.png", description: "정글의 고대 유적을 탐험.", genre: "모험" },
    { title: "해적선", image: "/images/pirate_Ship.png", description: "해적선의 선원이 되어 바다를 누벼라.", genre: "모험" },
    { title: "던전 탐험", image: "/images/DungeonExploration.png", description: "클래식한 던전 크롤링.", genre: "모험" },
  ...
  SF: [
    ...
    { title: "외계 행성", image: "/images/planet.png", description: "미지의 행성 탐사.", genre: "SF" },
    ...
    { title: "핑크 시티", image: "/images/Pink_City.png", description: "네온이 빛나는 미래 도시.", genre: "SF" },
  ],
  호러: [
    { title: "유령의 저택", image: "/images/ghost_mansion.png", description: "저주받은 저택의 공포.", genre: "호러" },
    { title: "유령의성", image: "/images/got.png", description: "고대 성의 그림자.", genre: "호러" },
